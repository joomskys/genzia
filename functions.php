...
function genzia_scripts()
{
	...
	wp_register_script('cms-process-sticky', get_template_directory_uri() . '/elementor/js/cms-process-sticky.js', ['jquery'], $theme->get('Version'), [
		'in_footer' => true,
		'strategy' => 'defer'
	]);
	wp_register_script('cms-stacking-accordion', get_template_directory_uri() . '/elementor/js/cms-stacking-accordion.js', ['jquery'], $theme->get('Version'), [
		'in_footer' => true,
		'strategy' => 'defer'
	]);
