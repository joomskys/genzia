...
$arrows_classes = [
    ...
    'bdr-1 bdr-transparent',
    'bdr-hover-accent-regular'
];
...
$posts_data = array(
    ...
    //
    'item_class'    => 'cms-swiper-item swiper-slide cms-hover-next-prev-all',
    'data-settings' => '',
...
<div <?php ctc_print_html($this->get_render_attribute_string('wrap')); ?>>
    ...
    <div <?php ctc_print_html($this->get_render_attribute_string('arrows-dots')); ?>>
        <?php
        // Arrows
        if ($arrows == 'yes') { ?>
