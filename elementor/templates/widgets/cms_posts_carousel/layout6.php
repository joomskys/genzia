...
$this->add_render_attribute('arrows', [
    'class' => [
        'cms-swiper-buttons d-flex gap-4 flex-auto',
...
$arrows_classes = [
    ...
    'bg-hover-'.$this->get_setting('arrows_bg_hover_color','primary-regular'),
    'bdr-1 bdr-'.$this->get_setting('arrows_border_color','menu'),
    'bdr-hover-'.$this->get_setting('arrows_border_hover_color','primary-regular')
];
...
$posts_data = array(
    ...
    'num_line'                   => !empty($this->get_setting('num_line')['size']) ? $this->get_setting('num_line')['size'] : 5,
...
<div <?php ctc_print_html($this->get_render_attribute_string('wrap')); ?>>
    ...
    <div class="d-flex justify-content-<?php if($dots != 'yes') echo 'center'; else echo 'between'; ?> gap-32 pt-40 empty-none"><?php
        // Arrows
        if ($arrows == 'yes'){ ?>
