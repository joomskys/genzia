...
$arrows_classes = [
    ...
    'bg-hover-'.$widget->get_setting('arrows_bg_hover_color','menu'),
    'bdr-1 bdr-'.$widget->get_setting('arrows_border_color','menu'),
    'bdr-hover-'.$widget->get_setting('arrows_border_hover_color','menu')
];
...
<div <?php ctc_print_html($widget->get_render_attribute_string('wrap')); ?>>
    ...
    <div class="d-flex justify-content-between gap-32 pt-15 empty-none"><?php
        // Arrows
        if ($arrows == 'yes'){ ?>
