...
<div class="stack-scatter--wrapper" style="--card-count: <?php echo esc_attr(count($accordions)); ?>">
	<div class="stack-scatter--inner" style="--sticky-offset: 136px;">
				...
				<div <?php ctc_print_html($this->get_render_attribute_string($item_key)); ?>>
					...
					<div <?php ctc_print_html($this->get_render_attribute_string($content_key)); ?>>
						...
						if (!empty($ac_document_text) && !empty($ac_document)) {
							...
							?>
							<a <?php ctc_print_html($this->get_render_attribute_string('download')); ?>>
								<?php
								// Icon
								genzia_svgs_icon([
									'icon' => 'arrow-right',
						...
						if (!empty($ac_feature_feature) || !empty($value['ac_feature_text'])) {
							...
							<div class="cms-ac-feature">
								<div <?php ctc_print_html($this->get_render_attribute_string('fdesc')); ?>>
									<?php echo esc_html($value['ac_feature_text']); ?>
								</div>
								<div class="cms-ac-feature-list d-flex gap-8 pt-25">
									...
									foreach ($ac_feature_feature as $fkey => $feature) {
										...
										?>
										<a <?php ctc_print_html(genzia_render_attrs($fitem_attrs)); ?>>
											<?php
		...
		<div <?php ctc_print_html($this->get_render_attribute_string('desc')); ?>>
			<?php
			// Text
