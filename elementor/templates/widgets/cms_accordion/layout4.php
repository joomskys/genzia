	...
	<?php 
		...
		foreach ( $accordions as $key => $value ):
			...
			$this->add_render_attribute( $item_title_key, [
				'class' => [ 
					...
					'text-hover-'.$this->get_setting('title_active_color','menu'),
					'text-on-hover-'.$this->get_setting('title_active_color','menu'),
					'text-active-'.$this->get_setting('title_active_color','menu'),
					'lh-1',
					'plus-minus'
				],
				'data-target' => '#'.$_id
			...
			if ( $is_active ) {
				$this->add_render_attribute( $content_key, 'style', 'display:flex;' );
			} else{
		...
		<div <?php ctc_print_html( $this->get_render_attribute_string( $item_key ) ); ?>>
		    ...
		    <div <?php ctc_print_html( $this->get_render_attribute_string( $content_key ) ); ?>>
		    	<div class="col-4 col-mobile-12 heading">
					<?php 
						// text
					...
					<?php }
						...
						genzia_elementor_link_render($this, $value, [
							...
							'name'			   => 'ac_link_',	
							'mode'			   => 'btn',
							'class'            => 'mt-12 cms-hover-change cms-hover-move-icon-right',
				...
				?>
					<div class="cms-ac-feature col-7 col-tablet-8 col-mobile-12">
