...
$this->add_render_attribute('heading', [
	'class' => [
		...
		'cms-title',
		'cms-sticky',
		'text-lg text-' . $this->get_setting('heading_color', 'body'),
		'elementor-invisible'
	],
