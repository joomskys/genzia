		...
		<div <?php ctc_print_html($this->get_render_attribute_string($counter_item_inner_key)); ?>>
			<?php
				...
				genzia_elementor_icon_image_render($widget, $settings, [
					'name'        => 'counter_icon',
					'size'        => 64,
					'color'       => $widget->get_setting('icon_color', 'menu'),
					'color_hover' => $widget->get_setting('icon_color', 'menu'),
					'class'       => 'cms-counter-icon flex-auto',
					'tag'         => 'div'
				], $counter);
			?>
...
<div class="d-flex gap-24 pt-40 empty-none"><?php 
	// Button #1
