...
<div <?php ctc_print_html($this->get_render_attribute_string('wrap')); ?>>
	...
	?>
		<div <?php ctc_print_html($this->get_render_attribute_string($item_key)); ?>>
			<div class="d-flex gap-24 flex-nowrap bdr-b-1 bdr-divider-dark justify-content-between cms-border">
				...
				<?php echo genzia_leading_zero($count, [
					'before' => '<div class="align-items-end lh-07 h2 text-on-dark mb-n10">', 
					'after'  => '</div>'
				]); ?>
			</div>
