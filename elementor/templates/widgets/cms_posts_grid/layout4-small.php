...
<div <?php ctc_print_html($this->get_render_attribute_string('wrap')); ?>>
    ...
    <?php if ($pagination_type == 'pagination') { ?>
        <div class="cms-grid-pagination mt-48 empty-none" data-loadmore="<?php echo esc_attr(json_encode($posts_data)); ?>"
    ...
    if (!empty($next_link) && $pagination_type == 'loadmore') { ?>
        <div class="cms-load-more text-center mt-48" data-loadmore="<?php echo esc_attr(json_encode($posts_data)); ?>" data-query="<?php echo esc_attr(json_encode($args)); ?>">
