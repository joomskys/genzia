...
$thumbnail_custom_dimension = [
    'width'  => !empty($settings['thumbnail_custom_dimension']['width']) ? $settings['thumbnail_custom_dimension']['width'] : 350,
    'height' => !empty($settings['thumbnail_custom_dimension']['height']) ? $settings['thumbnail_custom_dimension']['height'] : 525
];
$numn_line = !empty($this->get_setting('num_line')['size']) ? $this->get_setting('num_line')['size'] : 3;
...
<div <?php ctc_print_html($this->get_render_attribute_string('wrap')); ?>>
    ...
    <?php if ($pagination_type == 'pagination') { ?>
        <div class="cms-grid-pagination pt-40 empty-none" data-loadmore="<?php echo esc_attr(json_encode($posts_data)); ?>"
