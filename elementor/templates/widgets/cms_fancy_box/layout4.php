...
$this->add_render_attribute( 'title', [
	'class' => [
		...
		'text-hover-heading-regular',
		'text-on-hover-heading-regular',
		'text-xl',
		'm-tb-n7'
	]
]);
...
$this->add_render_attribute('features',[
    'class' => [
        ...
        'text-md',
        'text-'.$this->get_setting('fcolor', 'on-dark'),
        'text-hover-body',
        'text-on-hover-body',
        'pt-15 mb-n7',
...
<div <?php ctc_print_html($this->get_render_attribute_string('wrap')); ?>>
    ...
    <?php
	    ...
	    // 
		$count = 0;
		$count_negative = count($fancy_boxs);
		foreach ($fancy_boxs as $key => $fancy_box) { 
			...
			$this->add_render_attribute( $item_content_key, [
				'class' => array_filter([
					...
					'hover-icon-bounce',
					'cms-transition',
					'p-tb-48 p-lr-40 p-lr-smobile-16',
					'bg-backdrop bg-hover-white',
					'cms-shadow-1 cms-hover-shadow-2',
					'relative',
					($layout_mode == 'grid') ? 'elementor-invisible' : '',
					'd-flex gap-40 flex-nowrap align-items-start',
					'cms-hover-change'
				]),
				'data-settings' => wp_json_encode([
			...
			<div <?php ctc_print_html($this->get_render_attribute_string($item_content_key)); ?>>
				<?php
					...
					genzia_elementor_icon_image_render($widget, $settings,[
						'size'        => 48,
						'color'       => $this->get_setting('icon_color','white'),
			            ...
			            'img_size'	 => 'custom',
			            // default
			            'class'      => 'cms-ficon text-on-hover-'.$this->get_setting('icon_color','accent-regular'),
			            'before'     => '',
			            'after'      => '',
			            'echo'       => true,
			            'attrs'		 => []		
