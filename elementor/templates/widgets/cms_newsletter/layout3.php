...
$this->add_render_attribute('wrap', [
    ...
    'class' => [
        ...
        'bg-'.$this->get_setting('bg_color','menu'),
        'bdr-1 bdr-'.$this->get_setting('bdr_color','bg-dark'),
        'cms-radius-8'
    ],
    'style' => genzia_elementor_form_style_render($widget, $settings,[
        ...
        'field-border'         => 'divider-dark',
        'field-border-hover'   => 'accent-regular',
        'field-radius'         => 0,
        'field-padding-start'  => '0px',
        'field-padding-end'    => '120px',
        'placeholder-color'    => 'on-dark',
        // Button
        'btn-radius'      => 0,  
        'btn-height'      => 50,
        'btn-color'       => 'white',
        'btn-color-hover' => 'menu',
        'btn-bg'          => 'accent-regular',
        'btn-bg-hover'    => 'white',
        'btn-padding'     => '0 24px'
    ])
]);
...
$this->add_render_attribute('privacy_policy_text',[
    'class' => [
        'pp-text',
        'text-'.$this->get_setting('privacy_policy_text_color','on-dark')
    ]
]);
// Privacy Policy link
$this->add_render_attribute( 'privacy_policy_link_text', [
    'class' =>[
        ...
        'text-'.$this->get_setting('privacy_policy_link_text_color','on-dark'),
        'text-hover-'.$this->get_setting('privacy_policy_link_text_color','on-dark')
    ],
    //'href'  => get_permalink($this->get_setting('privacy_policy_page'))
]);
$this->add_link_attributes( 'privacy_policy_link_text', $settings['privacy_policy_page'] );
// Form Fields
$show_name = $this->get_setting('show_name','no');
// Shortcode
$fields = '[newsletter_form button_label="'.$this->get_setting('button_text',esc_html__('Subscribe','genzia')).'" class="cms-nlf-3 relative"]';
    if($show_name == 'yes'){
...
?>
    <div <?php ctc_print_html($this->get_render_attribute_string('wraps')); ?>>
