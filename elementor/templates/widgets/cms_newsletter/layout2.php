...
$this->add_render_attribute('wrap', [
    ...
    'style' => genzia_elementor_form_style_render($widget, $settings, [
        'field-height'             => 66,
        //'field-color'            => 'white',
        //'field-bg-color'         => 'sub-text',
        //'field-bg-hover-color'   => 'primary-regular',
        'field-border'             => 'divider',
        'field-border-hover'       => 'primary-regular',
        'field-border-width'       => '1px',
        'field-border-width-hover' => '1px',
        'field-radius'             => 0,
        'field-padding-start'      => '20px',
...
// Shortcode
$fields = '[newsletter_form button_label="'.$this->get_setting('button_text',esc_html__('Subscribe','genzia')).'" class="cms-nlf-2 relative"]';
    if($show_name == 'yes'){
