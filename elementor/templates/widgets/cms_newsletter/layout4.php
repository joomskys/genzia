...
$this->add_render_attribute('modal-btn-attrs',[
    'class'            => [
        'cms-btn',
        'btn-'.$this->get_setting('popup_btn_color', 'white'),
        'text-'.$this->get_setting('popup_btn_text_color', 'menu'),
...
$this->add_render_attribute('wrap', [
    ...
    'style' => genzia_elementor_form_style_render($widget, $settings,[
        ...
        'field-padding-start' => ($settings['layout_mode'] == 'plain') ? '20px' : 0,
        'field-padding-end'   => ($settings['layout_mode'] == 'plain') ? '20px' : 0,
        //
        'btn-color'         => 'white',
        'btn-color-hover'   => 'white',
        'btn-bg'            => 'accent-regular',
        'btn-bg-hover'      => 'primary-regular',
    ])
]);
// Content
...
$this->add_render_attribute('title', [
    'class' => [
        ...
        'empty-none',
        'text-xl',
        ($settings['layout_mode'] == 'plain') ? 'text-white' : 'text-heading-regular',
    ]
]);
// Desccription
...
$this->add_render_attribute('description', [
    'class' => [
        'cms-desc empty-none',
        ($settings['layout_mode'] == 'plain') ? 'text-on-dark' : 'text-body',
        'text-md',
        'pt-20'
    ]
]);
...
$this->add_render_attribute( 'privacy_policy_link_text', [
    'class' =>[
        ...
        ($settings['layout_mode'] == 'plain') ? 'text-white' : 'text-menu',
...
// Shortcode
$fields = '[newsletter_form button_label="'.$this->get_setting('button_text',esc_html__('Subscribe','genzia')).'" class="cms-nlf-1 relative d-flex gap-20 flex-column"]';
    if($show_name == 'yes'){
