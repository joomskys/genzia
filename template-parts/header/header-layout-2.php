        ...
        <div class="<?php echo genzia_header_container_classes('d-flex gap-32 gap-mobile-menu-10 justify-content-between align-items-start p-lr-48 p-lr-mobile-menu-20'); ?>">
            ...
            <div class="flex-auto d-flex justify-content-end gap-8 align-items-center">
                <div class="d-flex gap flex-auto cms-header-height bg-backdrop cms-radius-10 p-lr-24 p-lr-xsmobile-10" style="--cms-gap:96px;--cms-gap-mobile-menu:10px;">
                    ...
                    ?>
                    <div class="<?php echo genzia_header_tools_classes(['class' => 'flex-auto d-flex flex-nowrap gap-20 gap-xsmobile-10 align-items-center']); ?>"> 
                        <?php
                            // Phone
                            genzia_header_phone_render2([
                                'class' => 'menu-color pr-12 pr-mobile-menu-0'
                            ]);
                            // Mail
